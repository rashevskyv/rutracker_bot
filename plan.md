...
RuTracker Bot забезпечує моніторинг релізів трекера, збір оновлень хоумбрю, перекладів українською (SWUK), ручних релізів та знижок Nintendo eShop з мультирегіональним порівнянням цін та повною конвертацією в гривні (UAH) для всіх рядків цін.
...
### Модуль 4: Nintendo eShop Deals Module (v0.6.74) [Виконано]
