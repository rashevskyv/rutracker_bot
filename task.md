...
## Автоматичний збір усіх нових релізів від вчорашнього дня (v0.6.51)

- [x] Налаштувати збір усіх нових релізів від авторів `NaGaa95` та `ChanseyIsTheBest`, опублікованих починаючи від вчорашнього дня (`is_release_since_yesterday`)
- [x] Форматувати опис та назву релізу через **Gemini 3.5 Flash thinking**
